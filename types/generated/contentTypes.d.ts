...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    authorRole: Schema.Attribute.Enumeration<
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    instructorId: Schema.Attribute.String;
...
export interface ApiLmsUserLmsUser extends Struct.CollectionTypeSchema {
  collectionName: 'lms_users';
  info: {
    description: 'LMS Users list for role switcher simulation';
  ...
  attributes: {
    ...
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    enrolledCourseIds: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiQuizAttemptQuizAttempt extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    scorePercentage: Schema.Attribute.Integer;
...
export interface ApiUserCourseProgressUserCourseProgress
  ...
  attributes: {
    completedLessonIds: Schema.Attribute.JSON;
    courseId: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lastAccessedLessonId: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
